...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Aidy uses advanced AI algorithms to assist you with tasks, answer your questions, and help you stay on track.",
    },
    {
      question: "What features does Aidy offer?",
      answer:
        "Features include task reminders, goal tracking, personalized suggestions, and 24/7 availability.",
    },
    {
      question: "Is my data safe with Aidy?",
      answer:
        "Yes, Aidy prioritizes your privacy and uses advanced encryption to ensure your data is secure.",
    },
    {
      question: "Who can benefit from using Aidy?",
      answer:
        "Anyone looking to improve productivity, stay organized, and achieve their goals can benefit from Aidy.",
    },
    {
      question: "Can I join with my team on Aidy?",
      answer:
        "Yes, Aidy supports team collaboration features to help you and your team work together efficiently.",
    },
  ];
